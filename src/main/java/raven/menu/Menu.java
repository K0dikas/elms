...
public class Menu extends JPanel {
    ...
    private final String menuItems[][] = {
        {"~MAIN~"},
        {"Dashboard"},
            {"Subjects", "1st Year Subjects", "2nd Year Subjects", "3rd Year Subjects", "4th Year Subjects"},
            {"Profile"},
        {"~WEB APP~"},
            ...
            {"Calendar"},
        {"~TOOLS~"},
            {"Canvas", "MS Paint", "GIMP", "Canva"},
            {"Docs", "Word 2023", "PowerPoint 2023", "Excel 2023", "OneNote 2023"},
        {"~OTHER~"},
            {"Charts", "Pie Chart", "Bar Chart", "Line Chart", "Number Chart"},
        {"Logout"}
    };
    ...
    public void setMenuFull(boolean menuFull) {
        ...
        if (menuFull) {
            header.setText(Login.getHeader());
    ...
    private boolean menuFull = false;
    private final String headerName = Login.getHeader();
    ...
    private void init() {
        ...
        header = new JLabel(Login.getHeader());
        setLayout(new MenuLayout());
        putClientProperty(FlatClientProperties.STYLE, ""
                + "border:20,2,2,2;"
                + "background:$Menu.background;"
                + "arc:10");
        header.setIcon(new ImageIcon(getClass().getClassLoader().getResource("icon/png/logo.png")));
